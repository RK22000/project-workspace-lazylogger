...
/**
 * Model to track all the logs on a particular day.
 * Key is the jobActivity of log, and object is the log.
 * @author Rahul
 *
 */
...
/**
 * Method to add a Log to the DayLog. 
 * If a similar log is present then the log is appended to it, else a new key log pair is added.
 * @param log
